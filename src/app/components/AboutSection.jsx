            ...
            <div className='md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16'>
                ...
                <div className='mt-4 md:mt-0 text-left flex flex-col h-full' id="about">
                    ...
                    <p className='text-base md:text-lg mb-4'>
                        I'm an aspiring data scientist (hoping to get a PhD too) and lover of all things statistics. I was born and raised near Houston, Texas and lived there my entire life until going to college at UCLA. 
